// ==UserScript==
// @name        DeepSeek_Add_Buttons
// @version     0.0.1
// @description Adds buttons for DeepSeek
// @author      gtfish
...
// @updateURL       https://raw.githubusercontent.com/tgaochn/tampermonkey_script/master/LLM_add_buttons/DeepSeek_add_buttons.js
// @downloadURL     https://raw.githubusercontent.com/tgaochn/tampermonkey_script/master/LLM_add_buttons/DeepSeek_add_buttons.js
// ==/UserScript==
// TODO: 这个没做完, 之后再弄吧
// DeepSeek_add_buttons 0.0.1: init
...
`,
    ...
    async function main(utils) {
        try {
            ...
            const inputBoxSelector = "chat-input";
            const btnContainerSelector1 = "div[class='ds-button__icon']";
            const btnContainerSelector2 = "div[class='ds-button__icon']";
            ...
            const inputBoxElement = document.getElementById(inputBoxSelector);
